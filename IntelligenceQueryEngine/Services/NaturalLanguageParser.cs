...
public class NaturalLanguageParser
{
    public QueryParams Parse(string query)
    {
        ...
        // Country mapping (40+ countries supported)
        var countryMap = new Dictionary<string, string>
        {
            ...
            {"united states","US"},{"india","IN"},{"brazil","BR"},{"china","CN"},{"japan","JP"}
        };
        ...
        if (countryMatch.Success)
        {
            ...
            if (countryMap.TryGetValue(country, out var code)) result.CountryId = code;
        }
